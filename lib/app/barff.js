 ...
 */
var capitalizedWordCount = function (doc, features) {
    var currentTerm,
        terms = doc.terms
        i = terms.length - 1,
        capsWordCount = 0;
...
var maxDiffScore = function (doc, features) {
    var currentTerm,
        terms = doc.terms
        i = terms.length - 1,
        score = 0;
...
module.exports = function (config, callback) {
    ...
    activeFeatures = {
        ...
        "capitalizedWordCount": capitalizedWordCount,
        "maxDiffScore": maxDiffScore,
//        "textFeature": textFeature,
    ...
    if (activeFeatures.hasOwnProperty("capitalizedWordCount")) {
        headers.push(
            "@ATTRIBUTE capitalizedWordCount NUMERIC"
        );
    } //if

    if (activeFeatures.hasOwnProperty("maxDiffScore")) {
        headers.push(
            "@ATTRIBUTE maxDiffScore NUMERIC"
        );
    } //if
